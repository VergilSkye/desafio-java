...
public class PessoaService {
    ...
    public Long countCPF(String cpf, Long id) {
        return pessoaRepository.countCPFAndId(cpf, id);
    }
     ...
     * @param cpf the cpf
     */
    public Long countCPF(String cpf) {
        return pessoaRepository.countCPF(cpf);
    }
}
